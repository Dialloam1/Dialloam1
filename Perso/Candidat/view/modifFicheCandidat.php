...
<form class= "formInput" method="post" action="" onsubmit="return ficheCandidat()">
    <section>
        ...
        <div>
            ...
            <input type="tel" name="tel1" class="tel1" placeholder="entrez votre tel" required value="<?= @$candidat['tel_candidat'] ?>" minlength="10" maxlength="12">
        </div>
        <div>
            <label for="tel2">Autre téléphone</label>
            <input type="text" name="tel2" class="tel2" placeholder="entrez votre tel2" value="<?= @$candidat['tel2_candidat'] ?>" maxlength="13">
        </div>
    </section>
    <section>
        <div>
