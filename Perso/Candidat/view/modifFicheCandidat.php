...
<form action="" method="post" class="container-sm">
    ...
    <div>
        ...
        Homme: <input type="checkbox" class="form-control" name="homme" id="H">
        Femme: <input type="checkbox" class="form-control" name="femme" id="F">
...
<div>
    ...
    <input type="adresse" class="form-control" name="adresse" id="adresse2" placeholder="complement adresse">
</div>
...
<div class="input-group mb-3">
    <label class="input-group-text" for="inputGroupSelect01">Ville si autre que France</label>
