...
<!-- en même temps fiche complète d'inscription d'Accueil-->
...
<form action="log" method="post">
    ...
    <div>
        ...
        <input type="number" name="tel1" id="tel1" placeholder="entrez votre tel">
    </div>

    <div>
        <label for="tel">Autre téléphone</label>
        <input type="number" name="tel2" id="tel2" placeholder="entrez votre tel2">
    </div> <br>
